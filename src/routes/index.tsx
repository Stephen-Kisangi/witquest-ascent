...
const features = [
  { icon: <GraduationCap size={32} />, title: "CBC-Aligned Curriculum", desc: "Kenya's Competency-Based Curriculum brought to life through inquiry, projects and real-world skills." },
  { icon: <FlaskConical size={32} />, title: "STEM & Innovation", desc: "Smart boards, digital tools, labs and creative spaces from pre-primary upward." },
  { icon: <Palette size={32} />, title: "Creative Arts", desc: "Music, visual arts and drama to grow expressive, confident kids." },
  { icon: <Heart size={32} />, title: "Pastoral Care", desc: "Small classes (16–20 kids) and dedicated mentors who truly know every child." },
  { icon: <Globe size={32} />, title: "Kenyan Heart, Global Mind", desc: "Rooted in Kenyan values; preparing kids to thrive anywhere in the world." },
  { icon: <Landmark size={32} />, title: "Strong Values", desc: "Integrity, respect, civic duty and service rooted in everyday school life." },
];
